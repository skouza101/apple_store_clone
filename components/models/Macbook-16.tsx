...
export default function MacBookModel16(
  ...
  React.useEffect(() => {
    ...
    Object.values(materials).forEach((material) => {
      if (material instanceof THREE.MeshStandardMaterial) {
        // Set metalness for aluminum body
        ...
        if (props.itemColor && material.name !== "sfCQkHOWyrsLmor") {
          material.color.set(props.itemColor as THREE.ColorRepresentation);
        }
      }
    });
